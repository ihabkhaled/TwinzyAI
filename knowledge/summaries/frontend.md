---
id: summary-frontend
title: Frontend Summary — Anatomy, Modules, Vendors, State, i18n, PWA
type: summary
authority: canonical
status: current
owner: repository owner
generated: false
summary: Routing digest of apps/web — App Router anatomy, the two feature modules, the complete vendor-wrapper list, and the state/i18n/PWA approach.
keywords: [frontend, nextjs, app router, modules, vendor wrappers, tanstack query, zustand, i18n, rtl, pwa, sse client]
contextTier: 1
relatedCode: [apps/web/src/app/layout.tsx, apps/web/src/modules/game/hooks/useGame.hook.ts, apps/web/src/packages/env/public-env.ts, apps/web/src/proxy.ts]
relatedTests: [apps/web/src/tests/pwa.test.ts, apps/web/playwright.config.ts]
relatedDocs: [context/frontend/architecture-map.md, rules/frontend/00-non-negotiable-rules.md, rules/frontend/09-library-wrapping.md]
readWhen: You are changing apps/web and need the module anatomy, a vendor wrapper, or the state/i18n/PWA conventions.
---
