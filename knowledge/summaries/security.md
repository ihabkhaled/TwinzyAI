---
id: summary-security
title: Security Summary — Upload Chain, CSP, Rate Limits, Secrets, Scans
type: summary
authority: canonical
status: current
owner: repository owner
generated: false
summary: Routing digest of the security posture — the ordered upload chain, both CSP layers, every rate limit, secrets handling, and the trivy/audit/secret scan gates.
keywords: [security, upload chain, clamav, csp, rate limits, throttle, secrets, trivy, secret scanner, cors, helmet, payments security]
contextTier: 1
relatedCode: [apps/api/src/modules/file-security/application/file-security.service.ts, apps/web/src/shared/security/content-security-policy.ts, apps/api/src/bootstrap/configure-security.ts, apps/api/src/core/rate-limit/rate-limit.module.ts]
relatedTests: [apps/api/src/tests/game-analyze.integration.test.ts, apps/api/src/modules/file-security/tests/virus-scan.service.test.ts]
relatedDocs: [rules/15-file-upload-security.md, rules/06-security.md, docs/security-threat-model.md, SECURITY.md]
readWhen: You are touching uploads, headers/CSP, rate limits, secrets, dependencies, or anything in a threat model.
---
