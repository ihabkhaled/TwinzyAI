---
id: summary-current-risks
title: Current Risks Summary — Open Conditions, Debt, Staleness, Exposure
type: summary
authority: canonical
status: current
owner: repository owner
generated: false
summary: Routing digest of open risk — paywall LIVE conditions, SDLC artifact debt, the stale-mirror/copy cleanup backlog, provider-outage exposure, and every recorded doc/code drift.
keywords: [risks, paywall live conditions, stale mirrors, artifact debt, contradictions, provider outage, staleness, drift, single process, open items]
contextTier: 1
relatedCode: [apps/api/src/modules/payments/adapters/paypal.adapter.ts, .env.example, apps/web/src/packages/i18n/messages/en.json]
relatedTests: [apps/web/e2e/paywall.spec.ts]
relatedDocs: [docs/features/paypal-donations-and-paid-results/22-go-no-go.md, memory/known-pitfalls.md, docs/exceptions/README.md]
readWhen: You are planning work, reviewing a change against recorded policy, or need to know what is currently open, stale, or contradicted.
---
