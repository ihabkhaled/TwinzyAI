...
title: Bootstrap source (compiled into .ai/BOOTSTRAP.md)
type: knowledge-definition
authority: canonical
status: current
owner: repository owner
summary: Authored body of the agent bootstrap; the compiler injects open critical contradictions and enforces the 1,500-token budget.
keywords: [bootstrap, invariants, fast task protocol, authority, agent entrypoint]
contextTier: 0
relatedDocs: [knowledge/README.md, knowledge/contradiction-checks.yaml]
readWhen: editing the universal agent bootstrap
---
