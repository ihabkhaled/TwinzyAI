...
| **Prompt version** | `written-traits-v6` — the contract version every AI response must echo as a `z.literal`, locking prompts and schemas together. | `GAME_PROMPT_VERSION` in `packages/shared/src/constants/app.constants.ts` |
