...
| `typescript`                                         | ^5.9.3 (dev)             | Strict-mode contract for everything; typecheck runs via the native TypeScript 7 tsc.                | n/a (toolchain)                                                                                                                                       |
...
| Tool                                                   | Version                    | Role                                                                                                                                                                                             |
| ------------------------------------------------------ | -------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `tsc7` (npm alias of `typescript@7`)                    | ^7.0.2                 | Native TypeScript 7 `tsc` — typecheck + shared build; the `typescript` name resolves to the 6.0 API shim for tooling.                                                                                                          |
...
`lint` (`--max-warnings=0`), `typecheck` (native TypeScript 7 tsc), `test` /
