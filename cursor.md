...
- Twinzy is free by default: monetization only via the recorded owner-gated programs (the
  env-gated PayPal Orders v2 paywall per docs/features/paypal-donations-and-paid-results/22-go-no-go.md,
  blank credentials = fully free, LIVE not approved; plus the voluntary
