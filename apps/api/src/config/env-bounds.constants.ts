...
export const MIN_AI_ENSEMBLE_PARTICIPANTS = 1;
export const MAX_AI_ENSEMBLE_PARTICIPANTS = 6;
export const DEFAULT_AI_ENSEMBLE_MIN_SUCCESSFUL_PARTICIPANTS = 2;
export const DEFAULT_AI_ENSEMBLE_STEP_TIMEOUT_MS = 30_000;
export const DEFAULT_AI_ENSEMBLE_MAX_CANDIDATES_PER_MODEL = 10;
export const DEFAULT_AI_ENSEMBLE_MAX_COMBINED_CANDIDATES = 25;
export const MIN_PUBLIC_FIGURE_CACHE_TTL_SECONDS = 60;
export const MAX_PUBLIC_FIGURE_CACHE_TTL_SECONDS = 604_800;
export const DEFAULT_PUBLIC_FIGURE_CACHE_TTL_SECONDS = 86_400;
export const MIN_PUBLIC_FIGURE_CACHE_MAX_ITEMS = 1;
export const MAX_PUBLIC_FIGURE_CACHE_MAX_ITEMS = 10_000;
export const DEFAULT_PUBLIC_FIGURE_CACHE_MAX_ITEMS = 1000;
export const DEFAULT_PUBLIC_FIGURE_REQUEST_TIMEOUT_MS = 5000;
export const DEFAULT_PUBLIC_FIGURE_MAX_RESPONSE_BYTES = 250_000;
