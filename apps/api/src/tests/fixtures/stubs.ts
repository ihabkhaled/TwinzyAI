...
const CONFIG_DEFAULTS = {
  ...
  advancedMatching: {
    ...
    crossCritiqueEnabled: false,
    secondRetrievalPassEnabled: false,
    enrichmentEnabled: false,
    generationParticipants: [] as readonly AiRouteEntry[],
    judgeParticipants: [] as readonly AiRouteEntry[],
    critiqueParticipants: [] as readonly AiRouteEntry[],
    finalizer: undefined as AiRouteEntry | undefined,
    minSuccessfulParticipants: 2,
    stepTimeoutMs: 30_000,
    maxCandidatesPerModel: 10,
    maxCombinedCandidates: 25,
