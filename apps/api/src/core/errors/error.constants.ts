...
export const ERROR_MESSAGE_KEY_BY_CODE: Readonly<Record<ErrorCodeValue, ErrorMessageKey>> = {
  ...
  [ErrorCode.PaymentRequired]: 'errors.payment.required',
  [ErrorCode.PaymentOrderInvalid]: 'errors.payment.orderInvalid',
  [ErrorCode.PaymentProviderUnavailable]: 'errors.payment.providerUnavailable',
