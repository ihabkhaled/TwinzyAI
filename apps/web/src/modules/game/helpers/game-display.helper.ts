...
export const buildGameScreenLabels = (translate: TranslateMessage): GameScreenLabels => ({
  ...
  result: {
    ...
    improveResultsTitle: translate('result.improveResultsTitle'),
    improveResultsBody: translate('result.improveResultsBody'),
    improveResultsLinkLabel: translate('result.improveResultsLinkLabel'),
