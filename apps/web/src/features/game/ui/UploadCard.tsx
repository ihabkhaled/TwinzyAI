...
export const UploadCard = ({
  ...
  <Card>
    <label
      htmlFor="game-photo-input"
      className="flex min-h-32 cursor-pointer flex-col items-center justify-center gap-2 rounded-xl border-2 border-dashed border-border p-4 text-center hover:bg-surface-muted"
    >
