...
const HomePage = (): ReactNode => (
  <main id="main-content" className="mx-auto flex min-h-dvh max-w-xl flex-col justify-center px-4 py-10">
    <section className="text-center">
      ...
      <p className="mb-8 text-sm text-text-muted">{t('landing.privacyNotice')}</p>
      <Link
        href="/game"
